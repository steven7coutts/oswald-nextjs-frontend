...
export const servicesQuery = groq`*[_type == "service"]|order(featured desc, order asc, title asc){
  _id,
  title, 
  category, 
  serviceType,
...
export const projectsQuery = groq`*[_type == "project"]|order(featured desc, order asc, _createdAt desc){
  _id,
  title, 
  location, 
  projectType,
