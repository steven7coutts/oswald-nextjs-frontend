    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#3A2B1A] via-[#6B4226] to-[#2E2B29] pt-24 sm:pt-28 md:pt-32 lg:pt-36 xl:pt-40 pb-8 sm:pb-12 md:pb-16 lg:pb-20 xl:pb-24 scroll-mt-24 sm:scroll-mt-28 md:scroll-mt-32 lg:scroll-mt-36 xl:scroll-mt-40">
      ...
      <div className="relative z-20 text-center text-white px-4 sm:px-6 lg:px-8 xl:px-12 max-w-4xl sm:max-w-5xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-8xl mx-auto">
        ...
        <h1 className="font-heading font-bold mb-3 sm:mb-4 lg:mb-6 xl:mb-8 leading-tight tracking-tight">
          ...
          <div className="md:hidden space-y-1 sm:space-y-1.5 lg:space-y-2">
            <span className="block text-[#F4E1C6] text-lg sm:text-xl lg:text-2xl xl:text-3xl">
              {titleParts[0] || 'Bespoke Joinery'}
            </span>
            <span className="block text-[#C5862B] text-lg sm:text-xl lg:text-2xl xl:text-3xl">
          ...
          {data.heroCTAs && data.heroCTAs.length > 0 ? (
            data.heroCTAs.map((cta: HeroCTA) => (
              <a
                ...
                href={cta.href}
                className={`
                  group relative inline-flex items-center justify-center min-h-[32px] sm:min-h-[36px] lg:min-h-[40px] xl:min-h-[44px]
                  px-2 sm:px-2.5 lg:px-4 xl:px-5 py-1.5 sm:py-2 lg:py-2.5 xl:py-3 rounded-lg font-accent font-semibold 
                ...
                `}
              >
                <span className="relative z-10 inline-flex items-center gap-1 sm:gap-1.5 lg:gap-2">
                  {/view/i.test(cta.label) && (
                    <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg>
                  )}
                  {cta.label}
                  {/quote/i.test(cta.label) && (
                    <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 3.1 5.18 2 2 0 0 1 5 3h3a2 2 0 0 1 2 1.72c.12.81.3 1.6.54 2.36a2 2 0 0 1-.45 2.11L9 10a16 16 0 0 0 5 5l.81-.59a2 2 0 0 1 2.11-.45c.76.24 1.55.42 2.36.54A2 2 0 0 1 22 16.92z"/></svg>
                  )}
                </span>
                {/quote/i.test(cta.label) && (
        ...
        <div className="mt-4 sm:mt-6 lg:mt-8 xl:mt-10 mb-8 sm:mb-12 md:mb-16 lg:mb-20 xl:mb-24">
          <TrustIndicators />
        </div>
      </div>

      {/* Scroll indicator - Compact and visible */}
