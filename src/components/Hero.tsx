...
export default function Hero({ data }: HeroProps) {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#3A2B1A] via-[#6B4226] to-[#2E2B29] pt-16 sm:pt-20 md:pt-24 lg:pt-28 xl:pt-32 pb-6 sm:pb-8 md:pb-10 lg:pb-12 xl:pb-16 scroll-mt-16 sm:scroll-mt-20 md:scroll-mt-24 lg:scroll-mt-28 xl:scroll-mt-32">
      {/* Background Pattern */}
