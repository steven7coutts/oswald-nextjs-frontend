...
export default function Hero({ data }: HeroProps) {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#3A2B1A] via-[#6B4226] to-[#2E2B29] pt-24 sm:pt-28 md:pt-32 lg:pt-36 xl:pt-40 pb-8 sm:pb-12 md:pb-16 lg:pb-20 xl:pb-24 scroll-mt-24 sm:scroll-mt-28 md:scroll-mt-32 lg:scroll-mt-36 xl:scroll-mt-40">
      {/* Background Pattern */}
      ...
      <div className="relative z-20 text-center text-white px-4 sm:px-6 lg:px-8 xl:px-12 max-w-4xl sm:max-w-5xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-8xl mx-auto">
        ...
        <div className="mb-2 sm:mb-3 lg:mb-4 xl:mb-6">
          <span className="inline-block px-2 sm:px-2.5 lg:px-3 xl:px-4 py-1 sm:py-1.5 lg:py-2 xl:py-2.5 bg-[#C5862B]/20 border border-[#C5862B]/30 rounded-full text-[#C5862B] font-accent text-xs sm:text-sm lg:text-base xl:text-lg uppercase tracking-wider shadow-lg backdrop-blur-sm">
            Perth&apos;s Premier Joinery
          </span>
        </div>

        {/* Main Title - Responsive Typography */}
        <h1 className="font-heading font-bold mb-3 sm:mb-4 lg:mb-6 xl:mb-8 leading-tight tracking-tight">
        ...
        <p className="font-body font-light text-xs sm:text-sm lg:text-base xl:text-lg 2xl:text-xl mb-4 sm:mb-6 lg:mb-8 xl:mb-10 max-w-xl sm:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto text-[#F4E1C6]/90 leading-relaxed px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 lg:gap-4 xl:gap-5 justify-center items-center mb-4 sm:mb-6 lg:mb-8 xl:mb-10">
          {data.heroCTAs && data.heroCTAs.length > 0 ? (
            data.heroCTAs.map((cta: HeroCTA) => (
              <a
                ...
                href={cta.href}
                className={`
                  group relative inline-flex items-center justify-center min-h-[36px] sm:min-h-[36px] lg:min-h-[40px] xl:min-h-[44px]
                  px-3 sm:px-2.5 lg:px-4 xl:px-5 py-2 sm:py-2 lg:py-2.5 xl:py-3 rounded-lg font-accent font-semibold 
                  text-sm sm:text-sm lg:text-base xl:text-lg transition-all duration-300 ease-out
              ...
              >
                <span className="relative z-10 inline-flex items-center gap-1.5 sm:gap-1.5 lg:gap-2">
                  {/view/i.test(cta.label) && (
                    <svg className="w-3.5 h-3.5 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg>
                  )}
                  {cta.label}
                  {/quote/i.test(cta.label) && (
                    <svg className="w-3.5 h-3.5 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 3.1 5.18 2 2 0 0 1 5 3h3a2 2 0 0 1 2 1.72c.12.81.3 1.6.54 2.36a2 2 0 0 1-.45 2.11L9 10a16 16 0 0 0 5 5l.81-.59a2 2 0 0 1 2.11-.45c.76.24 1.55.42 2.36.54A2 2 0 0 1 22 16.92z"/></svg>
                  )}
                </span>
                {/quote/i.test(cta.label) && (
            ...
            <>
              ...
              <a
                href="#contact"
                className="group relative inline-flex items-center justify-center min-h-[36px] sm:min-h-[36px] lg:min-h-[40px] xl:min-h-[44px] px-3 sm:px-2.5 lg:px-4 xl:px-5 py-2 sm:py-2 lg:py-2.5 xl:py-3 rounded-lg font-accent font-semibold text-sm sm:text-sm lg:text-base xl:text-lg transition-all duration-300 ease-out bg-[#C5862B] hover:bg-[#C5862B]/90 text-[#3A2B1A] shadow-lg hover:shadow-xl hover:shadow-[#C5862B]/25 transform hover:-translate-y-0.5 active:translate-y-0 focus:outline-none focus:ring-2 focus:ring-[#C5862B] focus:ring-offset-2 focus:ring-offset-[#3A2B1A]"
              >
                <span className="relative z-10 inline-flex items-center gap-1.5 sm:gap-1.5 lg:gap-2">
                  <svg className="w-3.5 h-3.5 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 3.1 5.18 2 2 0 0 1 5 3h3a2 2 0 0 1 2 1.72c.12.81.3 1.6.54 2.36a2 2 0 0 1-.45 2.11L9 10a16 16 0 0 0 5 5l.81-.59a2 2 0 0 1 2.11-.45c.76.24 1.55.42 2.36.54A2 2 0 0 1 22 16.92z"/></svg>
                  Get a Free Quote
              ...
              <a
                href="#portfolio"
                className="group inline-flex items-center justify-center min-h-[36px] sm:min-h-[36px] lg:min-h-[40px] xl:min-h-[44px] px-3 sm:px-2.5 lg:px-4 xl:px-5 py-2 sm:py-2 lg:py-2.5 xl:py-3 rounded-lg font-accent font-semibold text-sm sm:text-sm lg:text-base xl:text-lg transition-all duration-300 ease-out bg-transparent hover:bg-[#F4E1C6]/10 text-[#F4E1C6] border-2 border-[#F4E1C6]/50 hover:border-[#F4E1C6] hover:text-white hover:bg-[#F4E1C6]/5 focus:outline-none focus:ring-2 focus:ring-[#F4E1C6] focus:ring-offset-2 focus:ring-offset-[#3A2B1A]"
              >
        ...
        {/* Trust Indicators - Minimal spacing */}
        <div className="mt-4 sm:mt-6 lg:mt-8 xl:mt-10 mb-6 sm:mb-10 md:mb-14 lg:mb-18 xl:mb-22">
          <TrustIndicators />
        </div>
      </div>

      {/* Scroll indicator - Closer on mobile, compact on desktop */}
      <div className="absolute bottom-1 sm:bottom-3 md:bottom-5 lg:bottom-7 xl:bottom-9 left-1/2 transform -translate-x-1/2 z-20 animate-bounce">
