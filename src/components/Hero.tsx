    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#3A2B1A] via-[#6B4226] to-[#2E2B29] pt-32 sm:pt-36 md:pt-40 lg:pt-44 xl:pt-48 pb-12 sm:pb-16 md:pb-20 lg:pb-24 xl:pb-28 scroll-mt-32 sm:scroll-mt-36 md:scroll-mt-40 lg:scroll-mt-44 xl:scroll-mt-48">
      ...
      <div className="relative z-20 text-center text-white px-4 sm:px-6 lg:px-8 xl:px-12 max-w-4xl sm:max-w-5xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-8xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6 lg:mb-8 xl:mb-10">
          <span className="inline-block px-3 sm:px-4 lg:px-5 xl:px-6 py-2 sm:py-2.5 lg:py-3 xl:py-3.5 bg-[#C5862B]/20 border border-[#C5862B]/30 rounded-full text-[#C5862B] font-accent text-xs sm:text-sm lg:text-base xl:text-lg uppercase tracking-wider shadow-lg backdrop-blur-sm">
            ...
            data.heroCTAs.map((cta: HeroCTA) => (
              <a
                ...
                className={`
                  ...
                  px-3 sm:px-4 lg:px-6 xl:px-8 py-2.5 sm:py-3 lg:py-3.5 xl:py-4 rounded-lg font-accent font-semibold 
      ...
      {/* Scroll indicator - Compact positioning */}
      <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 lg:bottom-10 xl:bottom-12 left-1/2 transform -translate-x-1/2 z-20 animate-bounce">
        <div className="w-4 h-6 sm:w-5 sm:h-8 md:w-6 md:h-10 lg:w-7 lg:h-12 xl:w-8 xl:h-14 border-2 border-[#F4E1C6]/30 rounded-full flex justify-center">
          <div className="w-1 h-1.5 sm:h-2 md:h-3 lg:h-4 xl:h-5 bg-[#C5862B] rounded-full mt-1.5 animate-pulse"></div>
        </div>
      </div>
    </section>
  )
