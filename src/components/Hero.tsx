...
export default function Hero({ data }: HeroProps) {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#3A2B1A] via-[#6B4226] to-[#2E2B29] pt-4 sm:pt-6 md:pt-8 lg:pt-10 xl:pt-12 pb-4 sm:pb-6 md:pb-8 lg:pb-10 xl:pb-12 scroll-mt-4 sm:scroll-mt-6 md:scroll-mt-8 lg:scroll-mt-10 xl:scroll-mt-12">
      {/* Background Pattern */}
      ...
      <div className="relative z-20 text-center text-white px-4 sm:px-6 lg:px-8 xl:px-12 max-w-4xl sm:max-w-5xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-8xl mx-auto">
        {/* Pre-title Badge */}
        <div className="mt-0 sm:mt-1 md:mt-2 lg:mt-3 xl:mt-4 mb-2 sm:mb-3 lg:mb-4 xl:mb-5">
